      ...
      <div className="mx-auto grid min-h-screen max-w-7xl gap-6 px-4 py-6 lg:grid-cols-[280px_minmax(0,1fr)] lg:px-6">
        <aside className="panel flex flex-col gap-6 p-5 lg:sticky lg:top-6 lg:h-[calc(100vh-3rem)]">
          <div>
            ...
            <h1 className="mt-2 font-display text-3xl text-ink">Atelier visuel</h1>
            <p className="mt-2 text-sm text-slate-600">Un espace simple pour composer ton site comme un atelier creatif.</p>
          </div>
        ...
        <main className="space-y-6">
          <header className="panel p-6">
            <p className="text-xs font-semibold uppercase tracking-[0.25em] text-pine/70">Mode atelier</p>
